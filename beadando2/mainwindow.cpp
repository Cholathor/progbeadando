...
{
    QLabel *k = new QLabel();
    QString filename = "C:/Users/Klenczner Márton/Documents/beadando2proba/futoszalag" + QString::number(t.irany) + ".png";
...
void MainWindow::shortest_path(int y1, int x1, int y2, int x2)
{
    ...
    QString filename = "C:/Users/Klenczner Márton/Documents/beadando2proba/futoszalag" + QString::number(uj_id) + ".png";
